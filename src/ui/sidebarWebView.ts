...
export class SidebarWebView {
    ...
    public updateContent(contracts: ContractInfo[], deployments: DeploymentRecord[], groups?: GroupHierarchy[]) {
        const html = this.getHtml(contracts, deployments, groups);
        this.webview.html = html;
    }

    private getHtml(contracts: ContractInfo[], deployments: DeploymentRecord[], groups?: GroupHierarchy[]): string {
